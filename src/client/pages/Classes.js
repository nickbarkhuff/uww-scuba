        ...
        <div className="Gutters">
            <section className="bg2 c1 p2 br1 bs1">
                ...
                <div className="taJustify">
                    ...
                    <p className="pb1">
                        After that, you need to respond to messages in a timely manner; if someone fills out your contact form but never gets a response, that could be the difference between getting a new customer or not.
                    </p>
                    <p>
