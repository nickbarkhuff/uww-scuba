    ...
    return (
        <Fragment>
            <div className="Gutters JumbotronHeight pt2 pb2 bgPositionCenter bgSizeCover" style={{backgroundImage: `url(${diver})`}}>
                <section className={"bg2Light dInlineBlock taCenter p2 br1 FadeInRight " + triggers.cta}>
                    <h1 className="fs4 fwBold pb1" ref={refs.cta}>Your diving adventure starts here</h1>
            ...
            <div className="Gutters">
                <section className={"bg1 c2 p2 taCenter br1 bs1 FadeIn " + triggers.hours}>
                    <h2 className="fs4 fwBold pb1" ref={refs.hours}>Hours</h2>
                    <p className="fs2 pb2">
            ...
            <div className="Gutters">
                <section className={"taCenter FadeIn " + triggers.video}>
                    <h2 className="fs4 fwBold pb1" ref={refs.video}>Welcome to UWW!</h2>
            ...
            <div className={"Gutters bg1 FadeIn " + triggers.new}>
                <section className="c2 pt2 pb2">
                    <h2 className="fs4 pb1" ref={refs.new}>What's new?</h2>
            ...
            <div className="Gutters">
                <section className={"fs2 FadeIn " + triggers.classes}>
                    <h2 className="fs4 pb1 taCenter fwBold" ref={refs.classes}>Jump right in</h2>
            ...
            <div className={"Gutters bgSizeCover bgPositionCenter FadeIn " + triggers.equipment} style={{backgroundImage: `url(${equipment})`}}>
                <section className={"taCenter p2"}>
                    <h2 className="fs4 fwBold pb1" ref={refs.equipment}>Is your equipment in good hands?</h2>
            ...
            <div className="Gutters">
                <section className={"fs2 taJustify FadeIn " + triggers.about}>
                    <h2 className="fs4 pb1 taCenter fwBold" ref={refs.about}>About us</h2>
                    <p className="pb1">
